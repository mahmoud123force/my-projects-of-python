...
# i wrote this code by pseudo code and then converted it to python code
'''
...
import re # i 've imported the re module to use regular expressions for checking the password criteria 
